...
def RandomizedSearch():
    ...
    file0.flush()
    return parameters
def ByesainRidgeReg(parameters, X_train,y_train,X_test, y_test):
    model = BayesianRidge(n_iter=parameters[0], 
                                     tol=parameters[1], 
                                     alpha_1=parameters[2], 
                                     alpha_2=parameters[3], 
                                     lambda_1=parameters[4], 
                                     lambda_2=parameters[5],  
                                     lambda_init=parameters[6], 
                                     compute_score=parameters[7], 
                                     fit_intercept=parameters[8], 
                                     verbose=parameters[9])
