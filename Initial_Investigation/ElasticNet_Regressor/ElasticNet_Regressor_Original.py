...
###############################################################################
LinModUak1 = ElasticNet().fit(X_trainUak1,y_trainUak1)
LinModUbk1 = ElasticNet().fit(X_trainUbk1, y_trainUbk1)
LinModUck1 = ElasticNet().fit(X_trainUck1, y_trainUck1)

LinModDak2 = ElasticNet().fit(X_trainDak2, y_trainDak2)
LinModDbk2 = ElasticNet().fit(X_trainDbk2, y_trainDbk2)
LinModDck2 = ElasticNet().fit(X_trainDck2, y_trainDck2)
