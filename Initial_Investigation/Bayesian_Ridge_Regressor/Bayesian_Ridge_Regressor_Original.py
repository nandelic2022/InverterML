...
###############################################################################
LinModUak1 = BayesianRidge().fit(X_trainUak1,y_trainUak1)
LinModUbk1 = BayesianRidge().fit(X_trainUbk1, y_trainUbk1)
LinModUck1 = BayesianRidge().fit(X_trainUck1, y_trainUck1)

LinModDak2 = BayesianRidge().fit(X_trainDak2, y_trainDak2)
LinModDbk2 = BayesianRidge().fit(X_trainDbk2, y_trainDbk2)
LinModDck2 = BayesianRidge().fit(X_trainDck2, y_trainDck2)
