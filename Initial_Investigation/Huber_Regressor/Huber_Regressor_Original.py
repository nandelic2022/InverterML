...
###############################################################################
LinModUak1 = HuberRegressor(max_iter=100).fit(X_trainUak1,y_trainUak1)
LinModUbk1 = HuberRegressor(max_iter=100).fit(X_trainUbk1, y_trainUbk1)
LinModUck1 = HuberRegressor(max_iter=100).fit(X_trainUck1, y_trainUck1)

LinModDak2 = HuberRegressor(max_iter=100).fit(X_trainDak2, y_trainDak2)
LinModDbk2 = HuberRegressor(max_iter=100).fit(X_trainDbk2, y_trainDbk2)
LinModDck2 = HuberRegressor(max_iter=100).fit(X_trainDck2, y_trainDck2)
